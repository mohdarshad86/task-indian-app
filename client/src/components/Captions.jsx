...
const Captions = ({ video, captionData }) => {
    ...
    return (
        ...
        <div style={{ textAlign: 'center' }}>
            ...
            <a style={{ width: 'max-content', textDecoration: "none" }} className='upload-btn' href={video} download>Download</a>
                    ...
                    <div className='caption-overlay'>
                        {captionData.map((caption) => {
                            return (
                                ...
                                <div className='caption-overlay-text'>
                                    <p className='text'>{caption.text}</p>
                                </div>
                            )
                        })}
